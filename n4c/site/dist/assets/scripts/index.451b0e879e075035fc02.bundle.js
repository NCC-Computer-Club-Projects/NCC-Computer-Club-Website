(self["webpackChunkn4c_website"] = self["webpackChunkn4c_website"] || []).push([[57],{
...
// NAMESPACE OBJECT: ./site/src/pages/index.tsx
...
;// CONCATENATED MODULE: ./site/src/contexts/index.tsx

const LayoutContext = (0,react.createContext)(null);

;// CONCATENATED MODULE: ./site/src/assets/scripts/utils/key-list.js
class KeyList {
  #keys = {};
  #numKeys = 0;
  constructor() {
    let newList = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
...
;// CONCATENATED MODULE: ./site/src/assets/images/logos/n4c/n4c-logo.svg
const n4c_logo_namespaceObject = __webpack_require__.p + "assets/images/1710a2c99ab853f8bec6.svg";
;// CONCATENATED MODULE: ./site/src/assets/scripts/utils/uppercase-all.js
...
;// CONCATENATED MODULE: ./site/src/components/PageLink/PageLink.tsx




function PageLink({ pageName, isActive, handleClick }) {
    const link = isActive ? (react.createElement(Link, { to: pageName === 'home' ? '/' : pageName, className: "nav-link active", "aria-current": "page" }, upperCaseAll(pageName))) : (react.createElement(Link, { to: pageName === 'home' ? '/' : pageName, className: "nav-link" }, upperCaseAll(pageName)));
    return (react.createElement("li", { className: "nav-item d-inline-flex align-items-center", onClick: handleClick }, link));
}

;// CONCATENATED MODULE: ./site/src/components/Header/Header.tsx
...
function Header() {
    const pages = (0,react.useContext)(LayoutContext);
    const [pageLinks, setPageLinks] = (0,react.useState)(() => {
        const pageMap = {};
    ...
    const selectLink = (clickedLink) => {
        ...
        setPageLinks(prevLinks => {
            // copy links
            const newLinks = Object.assign({}, prevLinks);
    ...
    for (const name in pageLinks) {
        const pageLink = (react.createElement(PageLink, { key: linkKeys.generateKey(name), handleClick: () => selectLink(name), pageName: name, isActive: pageLinks[name] }));
        linkComponents.push(pageLink);
    }
    return (react.createElement("header", { className: "header" },
        react.createElement("nav", { className: "navbar navbar-expand-md mx-3" },
            react.createElement("div", { className: "container-fluid justify-content-around align-items-md-stretch" },
                react.createElement(Link, { className: "navbar-brand d-inline-flex flex-row align-items-center gap-3", to: "/", onClick: () => selectLink('home') },
                    react.createElement("img", { src: n4c_logo_namespaceObject, height: 80, className: "rounded-circle" }),
                    react.createElement("h1", { className: 'm-0' }, "N4C")),
                react.createElement("button", { className: "navbar-toggler", "data-bs-toggle": "collapse", "data-bs-target": "#pages", "aria-controls": "pages", "aria-expanded": "false", "aria-label": "Toggle navigation" },
                    react.createElement("span", { className: "navbar-toggler-icon" })),
                react.createElement("div", { className: "collapse navbar-collapse justify-content-around", id: "pages" },
                    react.createElement("ul", { className: "navbar-nav justify-content-evenly gap-5 h-100" }, linkComponents))))));
}

;// CONCATENATED MODULE: ./site/src/components/FooterColumn/FooterColumn.tsx


function FormattedLink({ text, icon, destination }) {
    const iconContext = __webpack_require__(807);
    const [image, setImage] = (0,react.useState)({ src: '', svg: '' });
    const handleLoad = (e) => {
        setImage(prevImage => {
            const newImage = Object.assign(Object.assign({}, prevImage), { src: e.currentTarget.src });
            // newImage
            return newImage;
        });
    };
    return (react.createElement("li", { className: 'footer-link' },
        icon && react.createElement("img", { className: 'footer-icon', src: iconContext(icon), alt: text, onLoad: handleLoad }),
        react.createElement("a", { href: destination }, text)));
}
function FooterColumn({ title, links }) {
    const formattedLinks = links.map(link => react.createElement(FormattedLink, { key: link.text, text: link.text, icon: link.icon, destination: link.destination }));
    return (react.createElement("div", { className: 'footer-column' },
        react.createElement("h5", { className: 'footer-title' }, title),
        react.createElement("ul", { className: 'footer-content' }, formattedLinks)));
}

;// CONCATENATED MODULE: ./site/src/components/Footer/Footer.tsx
...
function Footer() {
    ...
    const columns = columnData.map(data => react.createElement(FooterColumn, { key: data.title, title: data.title, links: data.links }));
    return (react.createElement("footer", { className: 'footer' },
        react.createElement("div", { className: 'footer-top' },
            react.createElement("div", { className: 'logo-space' },
                react.createElement("div", { className: 'logo-space-logo d-inline-flex align-items-center' },
                    react.createElement("img", { src: n4c_logo_namespaceObject, className: 'rounded-circle' }),
                    react.createElement("h1", { className: 'm-0' }, "N4C")),
                react.createElement("div", { className: 'location' },
                    react.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", fill: "currentColor", className: "bi bi-geo-alt-fill", viewBox: "0 0 16 16" },
                        react.createElement("path", { d: "M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10m0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6" })),
                    react.createElement("p", null,
                        ...
                        "Founder's Hall 118",
                        react.createElement("br", null)))),
            react.createElement("div", { className: 'footer-columns' }, columns)),
        react.createElement("div", { className: 'footer-bottom' },
            react.createElement("p", null, "Copyright Northampton Community College \u00A92010-2024."),
            react.createElement("a", { href: '*' }, "Terms"))));
}

;// CONCATENATED MODULE: ./site/src/components/Layout/Layout.tsx
...
function Layout({ pageList }) {
    return (react.createElement(LayoutContext.Provider, { value: pageList },
        react.createElement(Header, null),
        react.createElement(Outlet, null),
        react.createElement(Footer, null)));
}

;// CONCATENATED MODULE: ./site/src/pages/Contact.tsx
...
;// CONCATENATED MODULE: ./site/src/pages/Error404.tsx


function Error404() {
    return (react.createElement("h1", { id: "Error404" }, "Error 404"));
}

;// CONCATENATED MODULE: ./site/src/components/Banner/Banner.tsx


function Banner({ header, main, action }) {
    return (react.createElement("div", { className: 'banner position-absolute' },
        react.createElement("h1", null, header),
        react.createElement("p", null, main),
        react.createElement("div", { className: 'action d-flex justify-content-end' },
            react.createElement("a", { href: action.link, target: '_blank', className: 'action-text d-inline-flex flex-row' },
                react.createElement("h4", null, action.text),
                react.createElement("h4", null, action.arrow && '\u2192')))));
}

;// CONCATENATED MODULE: ./site/src/assets/images/mock-images/mission.jpg
const mission_namespaceObject = __webpack_require__.p + "assets/images/740d1e18368cc495c6c6.jpg";
;// CONCATENATED MODULE: ./site/src/components/WorksCard/WorksCard.tsx



function WorksCard({ title, text }) {
    return (react.createElement("div", { className: 'works-card text-center animate__animated' },
        react.createElement("h4", null, title),
        react.createElement("p", null, text)));
}

;// CONCATENATED MODULE: ./site/src/pages/Home.tsx
...
function Home() {
    ...
    const worksCards = cardData.map(card => react.createElement(WorksCard, { key: card.title, title: card.title, text: card.text }));
    return (react.createElement("div", { id: 'Home' },
        react.createElement("section", { className: 'hero container-fluid position-relative p-0' },
            react.createElement(Banner, { header: 'Be At Skills USA', main: 'Support N4C as we take on SkillsUSA! Our members will compete in web design and cyber security.', action: {
                    link: 'https://www.skillsusa.org',
                    text: 'Check it out',
                    arrow: true
                } }),
            react.createElement("div", { className: 'event-time position-absolute' },
                react.createElement("h1", null,
                    "April 4",
                    react.createElement("br", null),
                    react.createElement("span", { className: 'light' },
                        "Thursday",
                        react.createElement("br", null)),
                    "12pm - 4pm",
                    react.createElement("br", null))),
            react.createElement("div", { className: "custom-shape-divider-bottom-1713741397" },
                react.createElement("svg", { "data-name": "Layer 1", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 1200 120", preserveAspectRatio: "none" },
                    react.createElement("path", { d: "M0,0V46.29c47.79,22.2,103.59,32.17,158,28,70.36-5.37,136.33-33.31,206.8-37.5C438.64,32.43,512.34,53.67,583,72.05c69.27,18,138.3,24.88,209.4,13.08,36.15-6,69.85-17.84,104.45-29.34C989.49,25,1113-14.29,1200,52.47V0Z", opacity: ".25", className: "shape-fill" }),
                    react.createElement("path", { d: "M0,0V15.81C13,36.92,27.64,56.86,47.69,72.05,99.41,111.27,165,111,224.58,91.58c31.15-10.15,60.09-26.07,89.67-39.8,40.92-19,84.73-46,130.83-49.67,36.26-2.85,70.9,9.42,98.6,31.56,31.77,25.39,62.32,62,103.63,73,40.44,10.79,81.35-6.69,119.13-24.28s75.16-39,116.92-43.05c59.73-5.85,113.28,22.88,168.9,38.84,30.2,8.66,59,6.17,87.09-7.5,22.43-10.89,48-26.93,60.65-49.24V0Z", opacity: ".5", className: "shape-fill" }),
                    react.createElement("path", { d: "M0,0V5.63C149.93,59,314.09,71.32,475.83,42.57c43-7.64,84.23-20.12,127.61-26.46,59-8.63,112.48,12.24,165.56,35.4C827.93,77.22,886,95.24,951.2,90c86.53-7,172.46-45.71,248.8-84.81V0Z", className: "shape-fill" })))),
        react.createElement("main", null,
            react.createElement("section", { className: 'mission' },
                react.createElement("h3", null, "Our Mission"),
                react.createElement("div", { className: 'mission-content' },
                    react.createElement("p", null,
                        react.createElement("img", { className: 'mission-img rounded-circle', src: mission_namespaceObject }),
            ...
            react.createElement("section", { className: 'works' },
                react.createElement("h3", null, "See What We're Working On!"),
                react.createElement("div", { className: 'card-display d-flex flex-wrap flex-row' }, worksCards)),
            react.createElement("section", { className: 'advisor' }))));
}

;// CONCATENATED MODULE: ./site/src/pages/Officers.tsx


function Officers() {
    return (react.createElement("div", { id: "Officers" }));
}

;// CONCATENATED MODULE: ./site/src/pages/PcRepair.tsx


function PcRepair() {
    return (react.createElement("div", { id: "PcRepair" }));
}

;// CONCATENATED MODULE: ./site/src/pages/Terms.tsx


function Terms() {
    return (react.createElement("div", { id: "Terms" }));
}

;// CONCATENATED MODULE: ./site/src/pages/Events.tsx


function Events() {
    return (react.createElement("div", { id: "Events" }));
}

;// CONCATENATED MODULE: ./site/src/pages/Resources.tsx


function Resources() {
    return (react.createElement("div", { id: "Resources" }));
}

;// CONCATENATED MODULE: ./site/src/pages/index.tsx
...
;// CONCATENATED MODULE: ./site/src/App.tsx
...
function App() {
    ...
    let pages = Object.keys(pages_namespaceObject);
    ...
    const pagesArr = Object.values(pages_namespaceObject); // array of page modules
    const routeKeys = new KeyList(); // initialize route keylist
    const routes = (() => {
        return pagesArr.map(PageComponent => {
            const name = PageComponent.name.toLowerCase();
            const newKey = routeKeys.generateKey(name); // generate key
            switch (name) {
                case 'error':
                case 'error404':
                    return react.createElement(Route, { key: newKey, path: "*", element: react.createElement(PageComponent, null) });
                case 'home':
                    return react.createElement(Route, { key: newKey, path: "/", element: react.createElement(PageComponent, null) });
                default:
                    return react.createElement(Route, { key: newKey, path: name, element: react.createElement(PageComponent, null) });
            }
        });
    })();
    const router = createBrowserRouter(createRoutesFromChildren(react.createElement(Route, { path: "/", element: react.createElement(Layout, { pageList: pageNavList }) }, routes)));
    return (react.createElement(dist_RouterProvider, { router: router }));
}

;// CONCATENATED MODULE: ./site/src/index.tsx
...
"use strict";
module.exports = __webpack_require__.p + "assets/images/97a9d1e47f711dece166.svg";
...
"use strict";
module.exports = __webpack_require__.p + "assets/images/610b2b7b54b88ce62048.svg";
...
"use strict";
module.exports = __webpack_require__.p + "assets/images/5260b94277173c0ae40d.svg";
...
"use strict";
module.exports = __webpack_require__.p + "assets/images/06ab0e0a4f0ccd8c826f.svg";
...
/******/ __webpack_require__.O(0, [96], () => (__webpack_exec__(664)));
/******/ var __webpack_exports__ = __webpack_require__.O();
/******/ }
]);
//# sourceMappingURL=index.451b0e879e075035fc02.bundle.js.map